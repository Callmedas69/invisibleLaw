...
paths:
  /v2/farcaster/cast/:
    get:
      ...
      description: >-
        Gets information about an individual cast by passing in a Farcaster web
        URL or cast hash
      ...
      parameters:
        ...
        - name: type
          in: query
          description: >-
            The query param accepted by the API. Sent along with identifier
            param.
        ...
        - name: viewer_fid
          in: query
          description: >-
            adds viewer_context to cast object to show whether viewer has liked
            or recasted the cast.
          schema:
            type: integer
            minimum: 1
      responses:
