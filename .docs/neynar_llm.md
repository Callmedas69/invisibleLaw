...
- [Set account association](https://docs.neynar.com/reference/associate-deployment.md): Associates a generated miniapp with a Farcaster account using a JFS-signed domain association. Requires API key authentication.
...
- [Create a miniapp generator deployment](https://docs.neynar.com/reference/create-deployment.md): Creates and deploys an instance of the miniapp generator for a user. Requires authentication via API key in the request header.
...
- [null](https://docs.neynar.com/reference/delete-neynar-frame.md)
...
- [null](https://docs.neynar.com/reference/fetch-composer-actions.md)
...
- [null](https://docs.neynar.com/reference/fetch-neynar-frames.md)
...
- [null](https://docs.neynar.com/reference/fetch-validate-frame-analytics.md)
- [null](https://docs.neynar.com/reference/fetch-validate-frame-list.md)
...
- [Get deployment info](https://docs.neynar.com/reference/get-deployment.md): Fetches info about a miniapp generator deployment by its deployment_id or name and creator's Farcaster ID. Requires API key authentication.
...
- [List deployments](https://docs.neynar.com/reference/list-deployments.md): Lists all miniapp generator deployments for a user. Requires API key authentication.
...
- [null](https://docs.neynar.com/reference/lookup-neynar-frame.md)
...
- [null](https://docs.neynar.com/reference/post-frame-action.md)
- [null](https://docs.neynar.com/reference/post-frame-action-developer-managed.md)
...
- [null](https://docs.neynar.com/reference/prompt-deployment.md)
...
- [null](https://docs.neynar.com/reference/publish-neynar-frame.md)
...
- [null](https://docs.neynar.com/reference/update-neynar-frame.md)
...
- [null](https://docs.neynar.com/reference/validate-frame-action.md)
...
- [Get Help →](https://neynar.com/slack)